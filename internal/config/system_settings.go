...
func (sm *SystemSettingsManager) DisplaySystemConfig(settings types.SystemSettings) {
	...
	logrus.Infof("    Sticky Key Mode: %t", settings.EnableStickyKey)
	logrus.Infof("    Sticky Key Failure Threshold: %d", settings.StickyKeyFailureThreshold)
	logrus.Infof("    Sticky Key Cooldown: %d seconds", settings.StickyKeyCooldownSeconds)
