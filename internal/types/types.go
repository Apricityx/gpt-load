...
type SystemSettings struct {
	...
	EnableStickyKey              bool   `json:"enable_sticky_key" default:"false" name:"config.enable_sticky_key" category:"config.category.key" desc:"config.enable_sticky_key_desc"`
	StickyKeyFailureThreshold    int    `json:"sticky_key_failure_threshold" default:"5" name:"config.sticky_key_failure_threshold" category:"config.category.key" desc:"config.sticky_key_failure_threshold_desc" validate:"required,min=1"`
	StickyKeyCooldownSeconds     int    `json:"sticky_key_cooldown_seconds" default:"30" name:"config.sticky_key_cooldown_seconds" category:"config.category.key" desc:"config.sticky_key_cooldown_seconds_desc" validate:"required,min=1"`
